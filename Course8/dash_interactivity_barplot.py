...
app.layout = html.Div(children=[html.H1("Total number of flights to the destination atate split by reporting air", style={"textAlign":"center","color":"#503D36","font-size":40}),
